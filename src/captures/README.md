...
Two parsers live in the project root:
...
python3 decode_inverted.py src/captures/try6.csv

# Decode just pin 6 (Console → Motor)
python3 decode_inverted.py src/captures/try6.csv 5

# Decode just pin 3 (Motor → Console)
python3 decode_inverted.py src/captures/try6.csv 2
```
...
```bash
python3 analyze_logic.py src/captures/try6.csv
```
